...
(function() {
    ...
    janrain.settings.appUrl                = 'https://livefyre-dev.rpxnow.com';
    janrain.settings.capture.captureServer = 'https://livefyre.dev.janraincapture.com';
    janrain.settings.capture.appId         = '864vmx6232yxtnk4ky69avuhcb';
    janrain.settings.capture.clientId      = 'fypkht4355sv49f854a3v3pt46nykch2';

    // These are the URLs for your Engage app's load.js file, which is necessary
    // to load the Capture Widget.
    var httpLoadUrl  = "http://widget-cdn.rpxnow.com/load/livefyre-dev";
    var httpsLoadUrl = "https://rpxnow.com/load/livefyre-dev";
